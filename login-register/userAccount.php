...
if(isset($_POST['signupSubmit'])){
    ...
    $redirectURL = ($sessData['status']['type'] == 'success')? 'http://www.grimlockpress.com/test_login/user/index.php':'registration.php';
    ...
    if(!empty($_POST['username']) && !empty($_POST['password'])){
        ...
        $sessData['status']['type'] = 'error';
        $sessData['status']['msg'] = 'UserName and password.'; 
    }
    //store login status into the session
    $_SESSION['sessData'] = $sessData;
    //redirect to the home page
    print_r($sessData['role']);
    if($sessData['role'] == "user"){
        header("Location:http://$host/test_login/user/index.php");    
    }else{
        header("Location: http://$host/test_login/add/index.php");
    }
